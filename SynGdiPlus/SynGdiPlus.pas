...
uses
  ...
  Graphics,
  {$endif}
  ActiveX{$IFNDEF PROFILE};{$ELSE}{},Profint;{$ENDIF}
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(383); try;{$ENDIF}
  result := (self<>nil) and (fHandle<>0);
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(383); end; {$ENDIF}
end;

function ProcLoad(H: HMODULE; Addr: PPointer; Names: PPChar): boolean;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(384); try;{$ENDIF}
  result := false;
  if Names<>nil then
    repeat
    ...
    until Names^=nil;
  result := true;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(384); end; {$ENDIF}
end;
...
var H: HMODULE;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(385); try;{$ENDIF}
  result := 0;
  H := SafeLoadLibrary(aDllFileName);
  if (H<>0) and ProcLoad(H,Addr,Names) then
    result := H;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(385); end; {$ENDIF}
end;

procedure TSynLibrary.UnLoad;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(386); try;{$ENDIF}
  if fHandle=0 then
    exit;
  FreeLibrary(fHandle);
  fHandle := 0;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(386); end; {$ENDIF}
end;
...
{$endif}
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(387); try;{$ENDIF}
...
{$endif}
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(387); end; {$ENDIF}
end;
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(388); try;{$ENDIF}
  dec(R.Right);
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(388); end; {$ENDIF}
end;
...
var R: TRect;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(389); try;{$ENDIF}
  result := nil;
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(389); end; {$ENDIF}
end;

destructor TGDIPlus.Destroy;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(390); try;{$ENDIF}
  ...
  UnLoad;
  inherited Destroy;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(390); end; {$ENDIF}
end;
...
var i: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(391); try;{$ENDIF}
  result := '';
  if Pic<>nil then
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(391); end; {$ENDIF}
end;

procedure TGDIPlus.RegisterPictures;
var i: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(392); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(392); end; {$ENDIF}
end;
...
var S: TMemoryStream;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(393); try;{$ENDIF}
  ...
  if Source.InheritsFrom(TGraphic) then begin // loading from a temp stream
    ...
    Clear;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(393); end; {$ENDIF}
end;

procedure TSynPicture.Clear;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(394); try;{$ENDIF}
  fHasContent := false;
  ...
  fGlobalLen := 0;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(394); end; {$ENDIF}
end;

constructor TSynPicture.CreateFromFile(const FileName: string);
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(395); try;{$ENDIF}
  inherited Create;
  LoadFromFile(FileName);
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(395); end; {$ENDIF}
end;

destructor TSynPicture.Destroy;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(396); try;{$ENDIF}
  Clear;
  inherited;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(396); end; {$ENDIF}
end;

procedure TSynPicture.Draw(ACanvas: TCanvas; const Rect: TRect);
var graphics: THandle;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(397); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(397); end; {$ENDIF}
end;
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(398); try;{$ENDIF}
  if (fImage<>0) and fAssignedFromBitmap and (DPI<>0) then
    Gdip.BitmapSetResolution(fImage,DPI,DPI);
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(398); end; {$ENDIF}
end;

procedure TSynPicture.fImageSet;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(399); try;{$ENDIF}
  if fImage=0 then
    exit;
  if (Gdip.GetImageWidth(fImage,fWidth)<>stOk) or
    ...
    Clear else
    fHasContent := true;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(399); end; {$ENDIF}
end;

function TSynPicture.GetEmpty: Boolean;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(400); try;{$ENDIF}
  result := not fHasContent;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(400); end; {$ENDIF}
end;

function TSynPicture.GetHeight: Integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(401); try;{$ENDIF}
  result := fHeight;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(401); end; {$ENDIF}
end;
...
var id: TGUID;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(402); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(402); end; {$ENDIF}
end;

function TSynPicture.GetWidth: Integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(403); try;{$ENDIF}
  result := fWidth;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(403); end; {$ENDIF}
end;
...
var Ext: TFileName;
    i: Integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(404); try;{$ENDIF}
  result := nil;
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(404); end; {$ENDIF}
end;

procedure TSynPicture.LoadFromClipboardFormat(AFormat: Word;
  AData: THandle; APalette: HPALETTE);
begin // not implemented
{$IFDEF PROFILE}try; Profint.PomoEnter(405); try;{$ENDIF}
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(405); end; {$ENDIF}
end;
...
{$IFDEF PROFILE}try; Profint.PomoEnter(406); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(406); end; {$ENDIF}
end;
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(407); try;{$ENDIF}
  if FindResource(Instance,PChar(ResName),RT_RCDATA) <> 0 then begin
    ...
    Clear;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(407); end; {$ENDIF}
end;

function TSynPicture.LoadFromIStream(Stream: IStream): TGdipStatus;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(408); try;{$ENDIF}
  ...
  if result=stOk then begin
    ...
    Clear;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(408); end; {$ENDIF}
end;

procedure TSynPicture.LoadFromStream(Stream: TStream);
var P: pointer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(409); try;{$ENDIF}
  Clear;
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(409); end; {$ENDIF}
end;

function TSynPicture.RectNotBiggerThan(MaxPixelsForBiggestSide: Integer): TRect;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(410); try;{$ENDIF}
  result.Left := 0;
  result.Top := 0;
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(410); end; {$ENDIF}
end;
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(411); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(411); end; {$ENDIF}
end;
...
var P: pointer;
    F: TGDIPPictureType;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(412); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(412); end; {$ENDIF}
end;

procedure TSynPicture.SaveToClipboardFormat(var AFormat: Word;
  var AData: THandle; var APalette: HPALETTE);
begin // not implemented
{$IFDEF PROFILE}try; Profint.PomoEnter(413); try;{$ENDIF}
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(413); end; {$ENDIF}
end;

procedure TSynPicture.SaveToStream(Stream: TStream);
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(414); try;{$ENDIF}
  SaveInternalToStream(Stream);
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(414); end; {$ENDIF}
end;

procedure TSynPicture.SetHeight(Value: Integer);
begin // not implemented
{$IFDEF PROFILE}try; Profint.PomoEnter(415); try;{$ENDIF}
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(415); end; {$ENDIF}
end;

procedure TSynPicture.SetWidth(Value: Integer);
begin // not implemented
{$IFDEF PROFILE}try; Profint.PomoEnter(416); try;{$ENDIF}
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(416); end; {$ENDIF}
end;

function TSynPicture.ToBitmap: TBitmap;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(417); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(417); end; {$ENDIF}
end;
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(418); try;{$ENDIF}
  inherited;
  fCompressionQuality := 80; // default quality
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(418); end; {$ENDIF}
end;

procedure TJpegImage.SaveToStream(Stream: TStream);
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(419); try;{$ENDIF}
  SaveAs(Stream,gptJPG,fCompressionQuality);
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(419); end; {$ENDIF}
end;
...
var wFrames: integer;
  wStrm: TMemoryStream;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(420); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(420); end; {$ENDIF}
end;

function TTiffImage.GetPageCount: integer;
var wCount: UINT;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(421); try;{$ENDIF}
  if fImage<>0 then begin
    Gdip.GetFrameCount(fImage, @FrameDimensionPage, wCount);
    result := wCount;
  end else
    result := 0;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(421); end; {$ENDIF}
end;

procedure TTiffImage.SelectPage(index: integer);
var wFrames: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(422); try;{$ENDIF}
  wFrames := GetPageCount;
  if (wFrames>0) and (cardinal(index)<cardinal(wFrames)) then begin
    Gdip.SelectActiveFrame(fImage, @FrameDimensionPage, index);
    fActivePage := index;
    ...
    raise ERangeError.Create('Invalid Page Index');
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(422); end; {$ENDIF}
end;
...
var Bmp: TBitmap;
    ...
    Pic: TSynPicture;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(423); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(423); end; {$ENDIF}
end;
...
var Stream: TStream;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(424); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(424); end; {$ENDIF}
end;
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(425); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(425); end; {$ENDIF}
end;

function LoadFromRawByteString(const Picture: {$ifdef UNICODE}RawByteString{$else}AnsiString{$endif}): TBitmap;
var ST: TStringStream;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(426); try;{$ENDIF}
  Result := nil;
  if Picture='' then
    exit;
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(426); end; {$ENDIF}
end;
...
var P: TSynPicture;
    ...
    Ext: TFileName;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(427); try;{$ENDIF}
  if FileExists(FileName) then begin
    ...
    result := nil;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(427); end; {$ENDIF}
end;

function LoadFrom(const MetaFile: TMetaFile): TBitmap; overload;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(428); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(428); end; {$ENDIF}
end;

procedure DrawEmfGdip(aHDC: HDC; Source: TMetaFile; var R: TRect;
  ForceInternalAntiAliased, ForceInternalAntiAliasedFontFallBack: boolean);
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(429); try;{$ENDIF}
  if (Gdip<>nil) and not Gdip.InheritsFrom(TGDIPlusFull) then
    FreeAndNil(Gdip); // we need the TGDIPlusFull features
  if Gdip=nil then
    // if specific gdiplus11.dll is not available then load OS default
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(429); end; {$ENDIF}
end;
...
var B: TBitmap;
    ...
    F: TGDIPPictureType;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(430); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(430); end; {$ENDIF}
end;
...
var Size, typ: DWORD;
    ...
    k: HKey;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(431); try;{$ENDIF}
  Result := '';
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(431); end; {$ENDIF}
end;
...
{$endif}
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(432); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(432); end; {$ENDIF}
end;
...
var i: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(433); try;{$ENDIF}
  GetMem(PI,n*8);
  for i := 0 to n*2-1 do
    PI^[i] := PW^[i];
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(433); end; {$ENDIF}
end;
...
var i: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(434); try;{$ENDIF}
  result := 0;
  for i := 0 to n-1 do
    inc(result,DX^[i]);
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(434); end; {$ENDIF}
end;

procedure SetPositions(X,Y: single; D: PGdipPointFArray; DX: PIntegerArray; n: Integer);
var i: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(435); try;{$ENDIF}
  for i := 0 to n-1 do begin
    D^[i].X := X;
    D^[i].Y := Y;
    X := X+DX^[i];
  end;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(435); end; {$ENDIF}
end;

procedure NormalizeRect(var Rect: TRect);
var tmp: integer;
begin // GDI+ can't draw twisted rects -> normalize such values
{$IFDEF PROFILE}try; Profint.PomoEnter(436); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(436); end; {$ENDIF}
end;
...
var X: TXForm;
    ...
    P32: PIntegerArray;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(437); try;{$ENDIF}
  result := true;
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(437); end; {$ENDIF}
end;
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(438); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(438); end; {$ENDIF}
end;

function TGDIPlusFull.MetaFileToStream(Source: TMetafile; out hGlobal: THandle): IStream;
var Length: cardinal;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(439); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(439); end; {$ENDIF}
end;
...
var Ref: TGDIPlusEnum;
    ...
    GR: TGdipRect;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(440); try;{$ENDIF}
  result := 0;
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(440); end; {$ENDIF}
end;

function TGDIPlusFull.getNativeConvertToEmfPlus: boolean;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(441); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(441); end; {$ENDIF}
end;
...
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(442); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(442); end; {$ENDIF}
end;

procedure TGDIPlusEnum.DeleteObj(index: integer);
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(443); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(443); end; {$ENDIF}
end;
...
var Img: THandle;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(444); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(444); end; {$ENDIF}
end;
...
var DF,RF: TGdipRectF;
    ...
    PrevClipRgn: THandle;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(445); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(445); end; {$ENDIF}
end;

procedure TGDIPlusEnum.EnumerateEnd;
var i: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(446); try;{$ENDIF}
  for i := 1 to nDC do
  ...
  DeleteDC(destDC);
  gdip.DeleteGraphics(graphics);
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(446); end; {$ENDIF}
end;

function AnsiICompW(u1, u2: PWideChar): integer;
var c1,c2: integer;
begin // faster than lstrcmpiW
{$IFDEF PROFILE}try; Profint.PomoEnter(447); try;{$ENDIF}
  repeat
    c1 := integer(u1^);
    c2 := integer(u2^);
    result := c1-c2;
    ...
    inc(u2);
  until false;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(447); end; {$ENDIF}
end;
...
var HF: HFONT;
    ...
    n: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(448); try;{$ENDIF}
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(448); end; {$ENDIF}
end;

function TGDIPlusEnum.GetCachedPen(color, width: Cardinal): THandle;
var i,n: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(449); try;{$ENDIF}
  for i := 0 to high(CachedPen) do
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(449); end; {$ENDIF}
end;

function TGDIPlusEnum.GetCachedSolidBrush(color: Cardinal): THandle;
var i,n: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(450); try;{$ENDIF}
  for i := 0 to high(CachedBrush) do
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(450); end; {$ENDIF}
end;

procedure TGDIPlusEnum.RestoreDC;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(451); try;{$ENDIF}
  assert(nDC>0);
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(451); end; {$ENDIF}
end;

procedure TGDIPlusEnum.SaveDC;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(452); try;{$ENDIF}
  Assert(nDC<high(DC));
  DC[nDC+1] := DC[nDC];
  inc(nDC);
  with DC[nDC] do begin
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(452); end; {$ENDIF}
end;
...
var P: TPoint;
    matrix: THandle;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(453); try;{$ENDIF}
  with DC[nDC] do begin
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(453); end; {$ENDIF}
end;

procedure TGDIPlusEnum.SetCachedFontSpec(aHandle: THandle; var aObjFont: TFontSpec);
var i: integer;
begin
{$IFDEF PROFILE}try; Profint.PomoEnter(454); try;{$ENDIF}
  for i := 0 to high(CachedFont) do
  ...
  Int64(aObjFont) := 0;
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(454); end; {$ENDIF}
end;

initialization

{$IFDEF PROFILE}try; Profint.PomoEnter(455); try;{$ENDIF}
{$IFDEF DEBUG} (* fixme: you must initialize on debug mode or pointer error on D2010 *)
...
{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(455); end; {$ENDIF}
finalization

{$IFDEF PROFILE}try; Profint.PomoEnter(456); try;{$ENDIF}
  Gdip.Free;

{$IFDEF PROFILE}except else Profint.PomoExce; end; finally; Profint.PomoExit(456); end; {$ENDIF}
end.
